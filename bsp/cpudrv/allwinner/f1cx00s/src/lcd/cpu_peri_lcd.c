...
//%$#@select,1
//#define       LCD_TYPE_RGB395_480_480
//#define       LCD_TYPE_RGB43_480_272
//#define       LCD_TYPE_RGB43_800_480
//#define       LCD_TYPE_RGB50_480_854
...
#ifdef  LCD_TYPE_RGB395_480_480
    #define CFG_LCD_XSIZE 480             //"LCD宽度-像素数",
    #define CFG_LCD_YSIZE 480             //"LCD高度-像素数",
    #define CFG_LCD_XSIZE_UM   70954       //"LCD宽度-微米数",
    #define CFG_LCD_YSIZE_UM   70954       //"LCD高度-微米数",
#endif
...
#endif
//-------------------------------------------
#ifdef LCD_TYPE_RGB50_480_854
    #define CFG_LCD_XSIZE 480             //"LCD宽度-像素数",
    #define CFG_LCD_YSIZE 854             //"LCD高度-像素数",
    #define CFG_LCD_XSIZE_UM   61560       //"LCD宽度-微米数",
    #define CFG_LCD_YSIZE_UM   109530       //"LCD高度-微米数",
#endif
//-------------------------------------------
#ifdef LCD_TYPE_RGB70_1024_600
    #define CFG_LCD_XSIZE 1024             //"LCD宽度-像素数",
    #define CFG_LCD_YSIZE 600              //"LCD高度-像素数",
    #define CFG_LCD_XSIZE_UM   101700      //"LCD宽度-微米数",
    #define CFG_LCD_YSIZE_UM   160700      //"LCD高度-微米数",
#endif
//-------------------------------------------
...
#ifdef  LCD_TYPE_RGB395_480_480
     1, 480,  80, 80,  8,   480,   18,  30,  2,   1, 1, 1, 0,   1,    0,        21,4, 6 //PCLK=9.75MHZ
#endif
#ifdef  LCD_TYPE_RGB43_480_272
...
#endif
#ifdef LCD_TYPE_RGB50_480_854
    1,  480, 50, 30,  10,   854,   40, 15,   3,   1, 1, 1, 0,   1,    0,        65, 4,13 //PCLK=30MHZ
#endif
#ifdef LCD_TYPE_RGB70_1024_600
...
u16 u16g_FrameBuffer[CFG_LCD_XSIZE*CFG_LCD_YSIZE] __attribute__((aligned(4)));  //用于图形系统
u16 u16g_VedioBuffer[CFG_LCD_XSIZE*CFG_LCD_YSIZE] __attribute__((aligned(4)));  //用于摄像头监视
...
//    u8 qq[20];
//    sprintf(qq,"111%p",dst_bitmap);
//    SJWL_BT_Data_Send(qq,20);
//    DJY_EventDelay(500 * 1000);
//    sprintf(qq,"222%p",src_bitmap);
//    SJWL_BT_Data_Send(qq,20);
//    DJY_EventDelay(500 * 1000);
    if((dst_bitmap->PixelFormat != CN_SYS_PF_RGB565)
...
///传dst_map
void lcd_blt_bm_to_bm(void *dst_map,void *src_map) {
    uint16_t *restrict dst = (uint16_t *)dst_map;
    uint16_t *restrict src = (uint16_t *)src_map;

    memcpy(dst_map, src_map, 480UL * 480UL * 2UL);
}
//----screen中画像素-----------------------------------------------------------
//功能: 在screen中画一个像素.
//参数: x、y，像素坐标
...
//    tg_lcd_display.bmmalloc = lcd_bmmalloc;
    ...
    printf("init lcd %x  %x \n\r",&tg_lcd_display, u16g_FrameBuffer);
